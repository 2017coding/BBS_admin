  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      <div class="filter-item">
        ...
        <el-input class="filter-item filter-input" v-model.trim="listInfo.query.keyword" placeholder="请输入电表编号/名称" clearable style="width: 180px"></el-input>
      </div>
    ...
    <el-table
      ...
      <el-table-column prop="metr_rate" label="CT" align="center" min-width="100px">
      </el-table-column>
      <el-table-column prop="metr_elicloss" label="电损" align="center" min-width="100px">
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
...
// 引入接口
import { getMeterListApi as getListApi } from '@/api/project/SMR0201A'
...
export default {
  ...
  mounted () {
    ...
    this.listInfo.query.masp_id = this.masp_id
  ...
  methods: {
    ...
    handleSelectionChange (rows) {
      ...
      this.$emit('update:selectRows',
        this.$fn.handleRepeatArr({data: [...this.selectRows, ...rows], key: 'metr_id'})
          .filter(item => selectIds.indexOf(item.metr_id) !== -1)
      )
    }
  }
}
