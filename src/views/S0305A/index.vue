<template>
  <div class="app-container S0304A">
    <el-tabs tab-position="left" v-model="activeName">
      <el-tab-pane v-for="(item, index) in entpList" :key="index" :name="index + ''" style="overflow-y: initial;">
        <span slot="label">
        ...
        <ChildrenPage :entpId="item.entp_id" :entpCode="item.entp_code" :tabInfo="{activeName, tabName: index + ''}" v-if="tabShowList[index]"></ChildrenPage>
      </el-tab-pane>
    </el-tabs>
  </div>
</template>
